      ...
      <v-expansion-panels>
        <v-expansion-panel title="Who am I?">
          <v-expansion-panel-text>
            ...
            security, drives my academic and professional goals. Beyond my core studies, I have a
            deep fascination with the infinite wonders of space, which once inspired me to consider
            a career in Astrophysics. I'm also an avid music enthusiast and enjoy immersing myself
            in the diverse worlds of anime.
          </v-expansion-panel-text>
        </v-expansion-panel>
        <v-spacer />
        <v-expansion-panel title="What is this website and what is its purpose?">
          <v-expansion-panel-text>
            ...
            project aimed at honing my skills in HTML and CSS. It was more than just about building
